...
public static class Strings
{
    ...
    private static readonly IReadOnlyDictionary<string, string[]> Supplemental =
        new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["TodoNoteWindowTitle"] = ["待办备注 · {0}", "Todo note · {0}", "ToDo メモ · {0}", "할 일 메모 · {0}"],
            ["TodoNoteDirtyWindowTitle"] = ["待办备注 · {0}（未保存）", "Todo note · {0} (unsaved)", "ToDo メモ · {0}（未保存）", "할 일 메모 · {0}(저장 안 됨)"],
            ["TodoNoteTaskIdentity"] = ["任务：{0}", "Task: {0}", "タスク：{0}", "작업: {0}"],
            ["TodoNoteUntitledTask"] = ["未命名任务", "Untitled task", "無題のタスク", "제목 없는 작업"],
            ["TodoNoteDirtyStatus"] = ["未保存", "Unsaved", "未保存", "저장 안 됨"],
            ["TodoNoteSwitchPrompt"] = ["“{0}”的备注尚未保存。要切换到“{1}”吗？", "The note for “{0}” is unsaved. Switch to “{1}”?", "「{0}」のメモは未保存です。「{1}」へ切り替えますか？", "‘{0}’ 메모가 저장되지 않았습니다. ‘{1}’(으)로 전환할까요?"],
            ["TodoNoteClosePrompt"] = ["“{0}”的备注尚未保存。", "The note for “{0}” is unsaved.", "「{0}」のメモは未保存です。", "‘{0}’ 메모가 저장되지 않았습니다."],
            ["TodoNoteDiscardAndSwitch"] = ["放弃并切换", "Discard and switch", "破棄して切り替え", "버리고 전환"],
            ["TodoNoteDiscardAndClose"] = ["放弃并关闭", "Discard and close", "破棄して閉じる", "버리고 닫기"],
            ["TodoNoteCancelSwitch"] = ["取消切换", "Cancel switch", "切り替えを中止", "전환 취소"],
            ["TodoNoteContinueEditing"] = ["继续编辑", "Continue editing", "編集を続ける", "계속 편집"],
            ["TodoNoteSaveFailed"] = ["无法保存：原任务已不存在或当前不可写。草稿仍保留在此窗口中。", "Could not save because the original task no longer exists or is not writable. The draft remains in this window.", "元のタスクが存在しないか書き込めないため保存できません。下書きはこのウィンドウに残っています。", "원래 작업이 없거나 현재 쓸 수 없어 저장하지 못했습니다. 초안은 이 창에 남아 있습니다."],
            ["TodoNoteDeleteTaskPrompt"] = ["“{0}”的备注尚未保存。处理草稿后才能删除任务。", "The note for “{0}” is unsaved. Resolve the draft before deleting the task.", "「{0}」のメモは未保存です。タスクを削除する前に下書きを処理してください。", "‘{0}’ 메모가 저장되지 않았습니다. 작업을 삭제하기 전에 초안을 처리하세요."],
            ["TodoNoteDeletePaperPrompt"] = ["这张待办纸仍有未保存的任务备注。处理草稿后才能删除纸片。", "This Todo paper has an unsaved task note. Resolve the draft before deleting the paper.", "この ToDo 用紙には未保存のタスクメモがあります。用紙を削除する前に下書きを処理してください。", "이 할 일 종이에 저장되지 않은 작업 메모가 있습니다. 종이를 삭제하기 전에 초안을 처리하세요."],
            ["TodoNoteDiscardAndDelete"] = ["放弃并删除", "Discard and delete", "破棄して削除", "버리고 삭제"],
            ["TodoNoteCancelDelete"] = ["取消删除", "Cancel deletion", "削除を中止", "삭제 취소"],
            ["TodoNoteExitPrompt"] = ["“{0}”的备注尚未保存。退出前请选择如何处理。", "The note for “{0}” is unsaved. Choose how to handle it before exiting.", "「{0}」のメモは未保存です。終了前に処理方法を選んでください。", "‘{0}’ 메모가 저장되지 않았습니다. 종료하기 전에 처리 방법을 선택하세요."],
            ["TodoNoteDiscardAndExit"] = ["放弃并退出", "Discard and exit", "破棄して終了", "버리고 종료"],
            ["TodoNoteCancelExit"] = ["取消退出", "Cancel exit", "終了を中止", "종료 취소"],
            ["TodoNoteExitDecisionStaged"] = ["已记录你的选择，正在等待其他备注草稿。", "Your choice is staged while the other note drafts are resolved.", "選択を記録しました。他のメモ下書きの処理を待っています。", "선택을 기록했습니다. 다른 메모 초안 처리를 기다리고 있습니다."],
            ["TodoNoteTaskInvalidated"] = ["原任务已被 MCP、插件或其他操作删除。为避免写错对象，此草稿已失效且不会保存；你可以复制内容后关闭窗口。", "The original task was deleted by MCP, a plugin, or another operation. To prevent writing to the wrong object, this draft is invalid and will not be saved; you may copy it before closing.", "元のタスクは MCP、プラグイン、または別の操作で削除されました。誤った対象への書き込みを防ぐため、この下書きは無効で保存されません。内容をコピーしてから閉じることができます。", "원래 작업이 MCP, 플러그인 또는 다른 작업으로 삭제되었습니다. 잘못된 대상에 쓰지 않도록 이 초안은 무효이며 저장되지 않습니다. 내용을 복사한 뒤 닫을 수 있습니다."],
            ["TodoNotePaperInvalidated"] = ["原待办纸已被 MCP、插件或其他操作删除。此草稿已失效且不会创建替代任务；你可以复制内容后关闭窗口。", "The original Todo paper was deleted by MCP, a plugin, or another operation. This draft is invalid and will not create a replacement task; you may copy it before closing.", "元の ToDo 用紙は MCP、プラグイン、または別の操作で削除されました。この下書きは無効で、代替タスクは作成されません。内容をコピーしてから閉じることができます。", "원래 할 일 종이가 MCP, 플러그인 또는 다른 작업으로 삭제되었습니다. 이 초안은 무효이며 대체 작업을 만들지 않습니다. 내용을 복사한 뒤 닫을 수 있습니다."],
            ["TodoNoteInvalidatedStatus"] = ["已失效", "Invalid", "無効", "무효"],
            ["TodoNoteInvalidatedWindowTitle"] = ["待办备注（原任务已失效）", "Todo note (original task unavailable)", "ToDo メモ（元のタスクは無効）", "할 일 메모(원래 작업 무효)"],
            ["CommonSave"] = ["保存", "Save", "保存", "저장"],
            ["CommonClose"] = ["关闭", "Close", "閉じる", "닫기"],
