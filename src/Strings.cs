...
public static class Strings
{
    ...
    private static readonly IReadOnlyDictionary<string, string[]> Supplemental =
        new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            ["TodoBoardCalendarView"] = ["日历", "Calendar", "カレンダー", "캘린더"],
            ...
            ["TodoBoardSearchToolTip"] = ["搜索任务、备注、纸片、状态或时间（Ctrl+F）", "Search tasks, notes, papers, status, or time (Ctrl+F)", "タスク、メモ、紙、状態、日時を検索（Ctrl+F）", "작업, 메모, 메모지, 상태 또는 시간 검색(Ctrl+F)"],
